...
import sys
sys.path.append("../../")
sys.path.append("/root/Firefly/Firefly/component")
...
def main():
    # 使用合并后的模型进行推理
    # model_name_or_path = 'FinGPT/fingpt-sentiment_internlm-20b_lora'
    # adapter_name_or_path = None
    model_name_or_path = '/root/Firefly/Firefly/checkpoint/firefly-internlm-20b-qlora-sft-merge'
    adapter_name_or_path = None
    ...
    # 生成超参配置
    max_new_tokens = 250  # 每轮对话最多生成多少个token
